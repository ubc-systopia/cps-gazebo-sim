...
def generate_launch_description():
    ...
    moveit_cfg = (
        MoveItConfigsBuilder("three_robots", package_name='three_robots')
        .to_moveit_configs()
    )
    ...
    robot_xacro_cmd = Command([
        ...
        PathJoinSubstitution([FindPackageShare('three_robots'), 'urdf', 'three_robots.urdf.xacro'])
    ])
    ...
    rviz_node = Node (
        ...
        arguments=["-d", os.path.join(
            get_package_share_directory("three_robots"),
            "config", "three_robots.rviz"
        )],
        parameters=[
    ...
    pkg_share = get_package_share_directory('three_robots')
