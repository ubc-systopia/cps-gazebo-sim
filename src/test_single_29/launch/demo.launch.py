...
def generate_launch_description():
    ...
    moveit_cfg = (
        MoveItConfigsBuilder("test_single_29", package_name='test_single_29')
        .to_moveit_configs()
    )
    ...
    robot_xacro_cmd = Command([
        ...
        PathJoinSubstitution([FindPackageShare('test_single_29'), 'urdf', 'test_single_29.urdf.xacro'])
    ])
    ...
    rviz_node = Node (
        ...
        arguments=["-d", os.path.join(
            get_package_share_directory("test_single_29"),
            "config", "test_single_29.rviz"
        )],
        parameters=[
    ...
    pkg_share = get_package_share_directory('test_single_29')
