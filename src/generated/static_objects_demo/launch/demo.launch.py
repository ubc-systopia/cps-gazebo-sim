...
def generate_launch_description():
    ...
    moveit_cfg = (
        MoveItConfigsBuilder("static_objects_demo", package_name='static_objects_demo')
        .to_moveit_configs()
    )
    ...
    robot_xacro_cmd = Command([
        ...
        PathJoinSubstitution([FindPackageShare('static_objects_demo'), 'urdf', 'static_objects_demo.urdf.xacro'])
    ])
    ...
    _world = os.path.join(get_package_share_directory("static_objects_demo"), "config", "world.sdf")
    ...
    rviz_node = Node (
        ...
        arguments=["-d", os.path.join(
            get_package_share_directory("static_objects_demo"),
            "config", "static_objects_demo.rviz"
        )],
        parameters=[
    ...
    pkg_share = get_package_share_directory('static_objects_demo')
