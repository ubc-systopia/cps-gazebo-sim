...
def generate_launch_description():
    ...
    moveit_cfg = (
        MoveItConfigsBuilder("test_double_6", package_name='test_double_6')
        .to_moveit_configs()
    )
    ...
    robot_xacro_cmd = Command([
        ...
        PathJoinSubstitution([FindPackageShare('test_double_6'), 'urdf', 'test_double_6.urdf.xacro'])
    ])
    ...
    rviz_node = Node (
        ...
        arguments=["-d", os.path.join(
            get_package_share_directory("test_double_6"),
            "config", "test_double_6.rviz"
        )],
        parameters=[
    ...
    pkg_share = get_package_share_directory('test_double_6')
